...
pub const JPEG_ASSET: &str = collect_assets::image!("./rustacean-flat-gesture.png", { format: jpeg });
pub const RESIZED_JPEG_ASSET: &str =
    collect_assets::image!("./rustacean-flat-gesture.png", { format: jpeg, size: (52, 52) });
pub const AVIF_ASSET: &str = collect_assets::image!("./rustacean-flat-gesture.png", { format: avif });
pub const RESIZED_AVIF_ASSET: &str =
    collect_assets::image!("./rustacean-flat-gesture.png", { format: avif, size: (52, 52) });
pub const WEBP_ASSET: &str = collect_assets::image!("./rustacean-flat-gesture.png", { format: webp });

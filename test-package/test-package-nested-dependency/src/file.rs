...
pub const JPEG_ASSET: manganis::ImageAsset = manganis::image!("./rustacean-flat-gesture.png", { format: jpeg });
pub const RESIZED_JPEG_ASSET: manganis::ImageAsset =
    manganis::image!("./rustacean-flat-gesture.png", { format: jpeg, size: (52, 52) });
pub const AVIF_ASSET: manganis::ImageAsset = manganis::image!("./rustacean-flat-gesture.png", { format: avif, low_quality_preview: true });
pub const RESIZED_AVIF_ASSET: manganis::ImageAsset =
    manganis::image!("./rustacean-flat-gesture.png", { format: avif, size: (52, 52) });
pub const WEBP_ASSET: manganis::ImageAsset = manganis::image!("./rustacean-flat-gesture.png", { format: webp });
